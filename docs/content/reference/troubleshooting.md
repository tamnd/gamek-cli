...
Most of these come down to network reality or how gamek serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

gamek rate-limits like any public site. gamek already paces
...
Where a surface is gated, gamek reads a cookie or token you supply
...
`gamek`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what gamek actually did
